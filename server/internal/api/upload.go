...
func DownloadFile(c *gin.Context) {
	...
	// Security: Reconstruct storageKey from verified components instead of using
	// the stored value directly. This prevents path traversal if the database
	// was compromised via NoSQL injection.
	// storageKey format: {roomID}/{fileID}.{extension}
	// We trust roomID (from URL, validated) and file.ID (from DB, generated by us as UUID)
