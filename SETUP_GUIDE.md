...
If you use **Nginx Proxy Manager** in front of NoteX, you **must** disable request buffering for the upload limit and speed indicator to work correctly.
...
Without this, NPM will buffer the entire file before sending it to NoteX, causing the upload to "hang" at 100% or appear slow.
